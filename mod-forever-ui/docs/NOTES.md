...
Mes notes, pas un livrable. Ce que le client de 2010 ne sait pas faire, les
écarts que la reproduction a dû prendre, les pièges qui ont coûté des
allers-retours, et l'état de l'outillage. **Rien ici n'a été demandé** : c'est
ce dont j'ai besoin pour ne pas réapprendre deux fois la même chose.

Ce qui a été demandé explicitement est dans `AMELIORATIONS.md`.

Chaque point dit **ce qui est en place**, **pourquoi**, et **ce qu'il faudrait
faire**.
