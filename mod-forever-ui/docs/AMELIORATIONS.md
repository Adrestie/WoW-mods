...
| **Les deux icônes PvP ne sont pas versées** | La feuille de 3.3.5 n'a pas d'onglet PvP — `CHARACTERFRAME_SUBFRAMES` en compte cinq, sans lui. Leurs identifiants sont notés dans le code pour le jour où elle en aura un ; les verser maintenant n'alourdirait `patch-Z` que pour rien. |
