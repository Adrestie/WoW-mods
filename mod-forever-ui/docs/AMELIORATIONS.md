...
| **L'icône n'est pas masquée** | La source la découpe par `common-sidetab-mask`, une `MaskTexture` que 3.3.5 n'a pas. Ses angles restent donc carrés là où la source les arrondit. |
